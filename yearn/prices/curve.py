...
class CurveRegistry(metaclass=Singleton):
    ...
    def get_balances(self, pool: AddressOrContract, block: Optional[Block] = None) -> List[float]:
        """
    ...
    def calculate_boost(self, gauge: Contract, addr: Address, block: Optional[Block] = None) -> float:
