...
class Treasury:
    ...
    def unit_debt(self, block: int = None) -> Dict[EthAddress,Dict[EthAddress,Dict[str,float]]]:
        if chain.id != Network.Mainnet: return
        if block and block < 11315910: return
    ...
    def compound_debt(self, block: int = None) -> Dict[EthAddress,Dict[EthAddress,Dict[str,float]]]:
